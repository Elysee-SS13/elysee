...
/*	allowed_branches = list(
	...
	access = list(access_maint_tunnels, access_bridge, access_emergency_storage, access_tech_storage,  access_cargo,
						access_cargo_bot, access_qm, access_mailsorting, access_expedition_shuttle, access_hangar,
...
/*	allowed_branches = list(
	...
	access = list(access_maint_tunnels, access_emergency_storage, access_cargo,
						access_cargo_bot, access_mailsorting, access_expedition_shuttle, access_hangar)
	minimal_access = list()
