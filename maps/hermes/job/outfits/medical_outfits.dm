/decl/hierarchy/outfit/job/hermes/crew/medical
	hierarchy_type = /decl/hierarchy/outfit/job/hermes/crew/medical
	l_ear = /obj/item/device/radio/headset/headset_med
	pda_type = /obj/item/modular_computer/pda/medical
	pda_slot = slot_l_store

/decl/hierarchy/outfit/job/hermes/crew/medical/New()
	..()
	BACKPACK_OVERRIDE_MEDICAL

/decl/hierarchy/outfit/job/hermes/crew/medical/senior
...
/decl/hierarchy/outfit/job/hermes/crew/medical/junior/fleet
	name = OUTFIT_JOB_NAME("Medical Resident - Fleet")
	uniform = /obj/item/clothing/under/solgov/utility/fleet/medical
	shoes = /obj/item/clothing/shoes/dutyboots

/decl/hierarchy/outfit/job/hermes/crew/medical/contractor/junior
...
/decl/hierarchy/outfit/job/hermes/crew/medical/contractor
	name = OUTFIT_JOB_NAME("Medical Technician - Contractor")
	uniform = /obj/item/clothing/under/rank/medical
	shoes = /obj/item/clothing/shoes/white
	id_types = list(/obj/item/weapon/card/id/hermes/contractor/medical)

/decl/hierarchy/outfit/job/hermes/crew/medical/contractor/mortus
	name = OUTFIT_JOB_NAME("Mortician")
	uniform = /obj/item/clothing/under/rank/medical/scrubs/black

/decl/hierarchy/outfit/job/hermes/crew/medical/contractor/paramedic
	name = OUTFIT_JOB_NAME("Paramedic - Hermes")
	uniform = /obj/item/clothing/under/rank/medical/paramedic
	suit = /obj/item/clothing/suit/storage/toggle/fr_jacket
	shoes = /obj/item/clothing/shoes/jackboots
	flags = OUTFIT_FLAGS_JOB_DEFAULT | OUTFIT_EXTENDED_SURVIVAL

/decl/hierarchy/outfit/job/hermes/crew/medical/contractor/chemist
	name = OUTFIT_JOB_NAME("Chemist - Hermes")
	uniform = /obj/item/clothing/under/rank/medical
	shoes = /obj/item/clothing/shoes/white
	pda_type = /obj/item/modular_computer/pda/medical
	id_types = list(/obj/item/weapon/card/id/hermes/contractor/chemist)
