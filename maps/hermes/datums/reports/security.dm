...
/datum/computer_file/report/recipient/sec/incident/generate_fields()
	..()
	add_field(/datum/report_field/text_label/header, "SEV Hermes Security Department")
...
/datum/computer_file/report/recipient/sec/evidence/generate_fields()
	...
	set_access(access_edit = access_security)
	temp_field = add_field(/datum/report_field/signature, "Sentry's signature")
...
/datum/computer_file/report/recipient/sec/arrest/generate_fields()
	...
	add_field(/datum/report_field/text_label/instruction, "This document MUST be submitted to, and reviwed by, the Executive Officer or Operational Officer.")
	add_field(/datum/report_field/signature, "Reporting Officer's signature")
	set_access(access_edit = access_security)
...
/datum/computer_file/report/recipient/sec/restraining/generate_fields()
	..()
	add_field(/datum/report_field/text_label/header, "SEV Hermes Security Department")
	add_field(/datum/report_field/text_label/instruction, "To be filled out by the Executive Officer, or Commanding Officer. Report must be signed and submitted for the order to be considered valid. Any paper copies must be stamped.")
