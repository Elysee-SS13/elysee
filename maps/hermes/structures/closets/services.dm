/decl/closet_appearance/secure_closet/hermes/hydroponics
	extra_decals = list(
...
/obj/structure/closet/janitor/WillContain()
	return list(
...
/obj/structure/closet/secure_closet/hydroponics_hermes //done so that it has no access reqs
	name = "hydroponics locker"
	req_access = list()
	closet_appearance = /decl/closet_appearance/secure_closet/hermes/hydroponics

/obj/structure/closet/secure_closet/hydroponics_hermes/WillContain()
	return list(
...
/obj/structure/closet/chefcloset_hermes/WillContain()
	return list(
