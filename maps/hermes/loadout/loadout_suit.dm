...
/datum/gear/suit/trenchcoat
	allowed_roles = list(/datum/job/assistant,  /datum/job/detective, /datum/job/submap/bearcat_captain, /datum/job/submap/bearcat_crewman,  /datum/job/submap/colonist, /datum/job/submap/pod)
	allowed_branches = CIVILIAN_BRANCHES
...
/datum/gear/suit/medical_poncho
	allowed_roles = list( /datum/job/doctor, /datum/job/psychiatrist)
	allowed_branches = CIVILIAN_BRANCHES
...
/datum/gear/suit/wintercoat_dais
	...
	allowed_roles = list(/datum/job/engineer, /datum/job/scientist)
	allowed_branches = CIVILIAN_BRANCHES
