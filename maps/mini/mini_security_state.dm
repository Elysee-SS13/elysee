...
/datum/map/mini // setting the map to use this list
	security_state = /decl/security_state/default/minidept

//mini map alert levels. Refer to security_state.dm.
/decl/security_state/default/minidept
	all_security_levels = list(/decl/security_level/default/minidept/code_green, /decl/security_level/default/minidept/code_violet, /decl/security_level/default/minidept/code_orange, /decl/security_level/default/minidept/code_blue, /decl/security_level/default/minidept/code_red, /decl/security_level/default/minidept/code_delta)

/decl/security_level/default/minidept
	icon = 'maps/mini/icons/security_state.dmi'

/decl/security_level/default/minidept/code_green
	name = "code green"
...
/decl/security_level/default/minidept/code_green/switching_down_to()
...
/decl/security_level/default/minidept/code_violet
	name = "code violet"
...
/decl/security_level/default/minidept/code_orange
	name = "code orange"
...
/decl/security_level/default/minidept/code_blue
	name = "code blue"
	icon = 'icons/misc/security_state.dmi'
...
/decl/security_level/default/minidept/code_red
	name = "code red"
	icon = 'icons/misc/security_state.dmi'
...
/decl/security_level/default/minidept/code_red/switching_up_to()
	security_announcement_red.Announce(up_description, "Attention! Code red alert procedures now in effect!")
	notify_station()
	GLOB.using_map.unbolt_saferooms()

/decl/security_level/default/minidept/code_red/switching_down_to()
...
/decl/security_level/default/minidept/code_delta
	name = "code delta"
...
/decl/security_level/default/minidept/code_delta/switching_up_to()
